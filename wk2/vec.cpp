...
int main()
{
    ...
    //for chapter 4
    vector<string> favs = {"Sifu", "HollowKnight", "Zelda", "Sekiro", "EldenRing"};
    ...
    do
    {
        ...
        {
            cout << "Let's remove an element from a global vector (global-ish).\n";
            ...
            cout << "What name should we remove?\n";
            string input;
            cin >> input;

            //auto becomes whatever var type you plug into it
            ...
            {
                cout << "I couldn't find that in your favs.\n";
            }
        }
        else 
        {
